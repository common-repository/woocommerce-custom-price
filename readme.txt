...
Contributors: azhkuro, maximsbarabash, wpmonkeyatl
Donate link: https://twitter.com/azhsetiawan
Tags: woocommerce, custom, price, products
...
Extends WooCommerce by adding an option to display custom text for products with free price and blank price.
...
1. WooCommerce Custom Price options

== Changelog ==

= 0.2.2 =
* Fixed: input text did not saved. (kudos wpmonkeyatl)
